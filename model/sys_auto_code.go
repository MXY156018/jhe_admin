...
func (autoCodeService *AutoCodeService) PreviewTemp(autoCode types.AutoCodeStruct) (map[string]string, error) {
...
func (autoCodeService *AutoCodeService) CreateTemp(autoCode types.AutoCodeStruct, ids ...uint) (err error) {
...
func (autoCodeService *AutoCodeService) GetTables(dbName string) (err error, TableNames []types.TableReq) {
...
func (autoCodeService *AutoCodeService) GetDB() (err error, DBNames []types.DBReq) {
...
func (autoCodeService *AutoCodeService) GetColumn(tableName string, dbName string) (err error, Columns []types.ColumnReq) {
...
func (autoCodeService *AutoCodeService) addAutoMoveFile(data *tplData) {
	...
	if strings.Contains(fileSlice[1], "server") {
		...
		} else if strings.Contains(fileSlice[n-2], "equipment") {
...
func (autoCodeService *AutoCodeService) AutoCreateApi(a *types.AutoCodeStruct) (ids []uint, err error) {
...
func (autoCodeService *AutoCodeService) getNeedList(autoCode *types.AutoCodeStruct) (dataList []tplData, fileList []string, needMkdir []string, err error) {
	// 去除所有空格
	...
	// resource/template/web/equipment.js.tpl -> autoCode/web/autoCode.PackageName/equipment/autoCode.PackageName.js
