...
func (exa *ExcelService) ParseInfoList2Excel(infoList []types.SysBaseMenu, filePath string) error {
...
func (exa *ExcelService) ParseExcel2InfoList() ([]types.SysBaseMenu, error) {
	skipHeader := true
	...
	menus := make([]types.SysBaseMenu, 0)
